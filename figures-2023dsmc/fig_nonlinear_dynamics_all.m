function fig_nonlinear_dynamics_all()
    ...
    ocv_lin_nmc = load_ocv_fn('nmc-affine');
    ocv_nmc = load_ocv_fn('nmc');
    ocv_lfp = load_ocv_fn('lfp');
    ocv_lin_lfp = load_ocv_fn('lfp-affine');
    max_hours = 5;
    ...
    plot_results_imbalance(res_lin_nmc, res_lin_lfp, res_nmc, res_lfp, max_hours)
    ...
    line(res_lin_nmc.zb(1), res_lin_nmc.za(1), 'Marker', 'x', 'MarkerSize', 18, 'LineStyle', 'none', 'LineWidth', 2, 'Color', 'k', 'DisplayName', 'I.C.')
    line(res_lin_nmc.zb, res_lin_nmc.za, 'LineWidth', 2, 'LineStyle', ':', 'Color', 'r', 'DisplayName', 'NMC/Gr (affine)')
...
function plot_results_imbalance(res_lin_nmc, res_lin_lfp, res_nmc, res_lfp, max_hours)
    ...
    t0 = res_lin_nmc.t_chg_cc;
    t1 = res_lin_nmc.t_chg_cv;
    ...
    % Affine
    line(res_lin_nmc.t./3600 - (t0-t2)/3600, res_lin_nmc.Ia - res_lin_nmc.Ib, 'LineStyle', '--', 'LineWidth', 2, 'Color', 'r', 'DisplayName', 'NMC/Gr (affine)')
    line(res_lin_lfp.t./3600 - (t0-t2)/3600, res_lin_lfp.Ia - res_lin_lfp.Ib, 'LineStyle', '--', 'LineWidth', 2, 'Color', 'b', 'DisplayName', 'LFP/Gr (affine)')
    ...
    % Decorators
    xline(res_lin_nmc.t_chg_cc./3600 - (t0-t2)/3600, 'LineStyle', ':', 'Color', 'k', 'LineWidth', 1, 'HandleVisibility', 'off', 'Parent', ax1)
    xline(res_lin_nmc.t_chg_cv./3600 - (t0-t2)/3600, 'LineStyle', ':', 'Color', 'k', 'LineWidth', 1, 'HandleVisibility', 'off', 'Parent', ax1)
...
%     ylim([-0.4 +0.4])
    ...
    line(res_lin_nmc.t./3600 - (t0-t2)/3600, res_lin_nmc.za - res_lin_nmc.zb, 'LineStyle', '--', 'LineWidth', 2, 'Color', 'r', 'DisplayName', 'NMC/Gr (affine)')
    line(res_lin_lfp.t./3600 - (t0-t2)/3600, res_lin_lfp.za - res_lin_lfp.zb, 'LineStyle', '--', 'LineWidth', 2, 'Color', 'b', 'DisplayName', 'LFP/Gr (affine)')
    ...
    xline(res_lin_nmc.t_chg_cc./3600 - (t0-t2)/3600, 'LineStyle', ':', 'Color', 'k', 'LineWidth', 1, 'HandleVisibility', 'off', 'Parent', ax2)
    xline(res_lin_nmc.t_chg_cv./3600 - (t0-t2)/3600, 'LineStyle', ':', 'Color', 'k', 'LineWidth', 1, 'HandleVisibility', 'off', 'Parent', ax2)
