function fig_ocv_functions()
    ...
    line(xx, nmc_affine(xx), 'LineWidth', 2, 'LineStyle', '--', 'Color', 'r', 'DisplayName', 'NMC/Gr, affine')
    line(xx, nmc(xx), 'LineWidth', 2, 'LineStyle', '-', 'Color', 'r', 'DisplayName', 'NMC/Gr')
    line(xx, lfp_affine(xx), 'LineWidth', 2, 'LineStyle', '--', 'Color', 'b', 'DisplayName', 'LFP/Gr, affine')
